...
const DashboardDetailView: React.FC<DashboardDetailViewProps> = ({
  ...
  const onLayoutChange = (layout: any) => {
    const currentLayouts = layout;
    console.log("onchange : layouts", currentLayouts);
    //drop이 있을경우
    //const currentBreakpointLayout = currentLayouts[currentBreakpoint];
    //console.log("currentlayout:", currentBreakpointLayout);
    // if (currentBreakpointLayout) {
    //   const droppingElem = currentBreakpointLayout.find((item: any) => item.i === "__dropping-elem__");
    ...
    console.log("layoutchange - state:", state);
  };

  

  const onDrop = (layout: Layout[], layoutItem: Layout, event: Event) => {
    const currentLayoutItem = layoutItem;
    console.log("onDrop : layout item", currentLayoutItem);
  ...
  const onResize = (layout: any, layouts: any) => {
  ...
  return (
    <>
      ...
      <ResponsiveGridLayout
        ...
        isResizable={isEditMode && resizable}
        ...
        {widgets.map((widget, index) => (
          ...
          <div 
            ...
            data-grid={{ 
              ...
              maxH: 5 - state.layouts[currentBreakpoint][index].x,
              maxW: 6 - state.layouts[currentBreakpoint][index].y,
            }}
          >
